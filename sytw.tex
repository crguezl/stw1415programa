...
\item Framework webs: Rack, Sinatra, Express
\item Despliegue de aplicaciones Web: Heroku, Amazon AWS
\item TDD y BDD en la web: Cucumber, Capybara, Rack-Test, Selenium, Poltersgeit (PhantomJS)
  \item
\item Autorización y Autenticación: Oauth, Omniauth, OpendId, ...
...
\item Gráficos: SVG, Rafäel, Canvas
