...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{
Sistemas y Tecnologías Web (2013-2014)
} 
...
\htmladdtonavigation{\htmladdnormallink{\htmladdimg[width=40 alt="PP2moodle"]{moodlePP2logo.jpeg}}
{http://campusvirtual.ull.es/1314/course/view.php?id=1091}}
...
\item 
Grupo L2 los Miércoles de 10:30 a 12:20 en la sala 1.2.
\item 
Grupo L3 los Viernes de 8:30 a 10:20 en la sala 2.3.
\item 
Grupo L1 los Viernes de 10:30 a 12:20 en la sala 2.3.
\item 
Tutorías de Lunes a Viernes de 14:48 a 16:00 en el despacho 96 de la 4ª planta del edificio de Física/Matemáticas
...
\htmladdnormallink{http://www.ull.es/view/institucional/ull/Calendario\_vigente/es}{http://www.ull.es/view/institucional/ull/Calendario\_vigente/es}.

\begin{rawhtml}
Agenda de Sistemas y Tecnologías Web<p>
<iframe src="https://www.google.com/calendar/embed?mode=AGENDA&amp;height=340&amp;wkst=2&amp;bgcolor=%23FFFFFF&amp;src=ull.edu.es_8qki60uonmdf0ri6cha0ma7ifk%40group.calendar.google.com&amp;color=%23853104&amp;ctz=Atlantic%2FCanary" style=" border:solid 1px #777 " width="800" height="340" frameborder="0" scrolling="no"></iframe>"
\end{rawhtml}"
...
Cada alumno realiza una presentación de 15 minutos.
El alumno realiza tres de estas exposiciones por curso. En la mayoría de los casos sobre el mismo tema en diferentes niveles de profundidad: básico, intermedio y avanzado.
...
\item ASP.NET
  \begin{enumerate}
  \item ASP.NET MVC Framework (ASP.NET MVC)
  \item MonoRail
  \item DotNetNuke
  \item Nancy (Sinatra like)
  \end{enumerate}
\item ECMAScript
  \begin{enumerate}
  \item Flex
...
Se trata de pr\'acticas tutorizadas y prácticas de entregar 
que se realizan durante la clase.
Además está el proyecto final presentado por el grupo.

\section{Evaluación}
\begin{itemize}
\item
La calificación se divide en dos partes: prácticas por un lado y presentaciones por otro. 
\item
Las presentaciones e informes son el 30\% de la nota. 
Las prácticas y los informes de prácticas - evaluadas individualmente -
son el 70\% de la nota. 
\item
Haremos también tres micro-exámenes, apróximadamente en las semanas quinta, décima y quince para co-evaluar la parte práctica.
Los microexámenes son el 30\% de la nota práctica.
\item
Es necesario aprobar las dos partes y cada uno de los microexámenes para superar
la asignatura.
\end{itemize}
